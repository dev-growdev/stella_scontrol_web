  ...
  return (
    <React.Fragment>
      <Autocomplete
        ...
        clearOnBlur
        handleHomeEndKeys
        renderOption={(props, option) => <li {...props}>{option.product} {option.brand ? `| ${option.brand}` : ''}</li>}
        fullWidth
        freeSolo
        renderInput={(params) => <TextField {...params} label="Digite um produto" onChange={handleInputChange} />}
      />
